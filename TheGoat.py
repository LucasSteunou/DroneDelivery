...
## Excel, découpage,...
data=pd.read_excel(r"C:\Users\steun\Desktop\TIPE\filaire-de-voirie.xlsx")
T=pd.DataFrame(data,columns=['Geo Shape','longueur'])
T=np.array(T)
A=['a','z','e','r','t','y','u','i','o','p','q','s','d','f','g','h','j','k','l','m','w','x','c','v','b','n','M','L','S','{','}','"',':']
...
M=[[m.inf for i in range(n)] for j in tqdm(range(n))]
